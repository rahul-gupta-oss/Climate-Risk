...
for index, row in df_no_duplicates.iterrows():
    ...
    # Rainfall data link
    base_dir = 'Daily_rainfall_actual'

    request_url = 'https://ukclimateprojections-ui.metoffice.gov.uk/wps?service=wps&request=Execute&version=1.0.0&Identifier=LS6_Subset_02&Format=text/xml&Inform=true&Store=false&Status=false&DataInputs=Area={};'\
                  'Collection=land-obs_25;DataFormat=csv;TemporalAverage=day;TimeSlice=2000%7C2021;Variable=rainfall'
    Area_value = row['Area']
    ...
    for filename in os.listdir(base_dir):
        if filename.endswith(".csv"):
            ...
            suffix = "_DRA"  # Replace with your desired suffix
            ...
            output_csv_path = '/Users/rahulrahul/Documents/Python/Data/Actual_rainfall_output.csv'
