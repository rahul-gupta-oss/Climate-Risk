...
shapefile_path = '/Users/rahulrahul/Downloads/GeoSureHexGrids-2/Data/GB_Hex_5km_GS_ShrinkSwell_v8.shp'

# Read the shapefile
gdf = gpd.read_file(shapefile_path)

output_csv_path = '/Users/rahulrahul/Documents/Python/Data/subsidence_raw_data.csv'
gdf.to_csv(output_csv_path, index=False)
with open('/Users/rahulrahul/Documents/Python/Data/subsidence_raw_data.csv', 'r') as csv_file:
...
merged_result.dropna(subset=['Legend'], inplace=True)
output_csv_path = '/Users/rahulrahul/Documents/Python/Data/subsidence_final_data.csv'
