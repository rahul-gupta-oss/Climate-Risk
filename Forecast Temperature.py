...
folder_path = 'Forecasted_Temperature'
...
for index, row in df_no_duplicates.iterrows():
    # Download the actual data for maximum temperature for last 20 years, if needed, change the parameters in the below URL
    
    # Rainfall data link
    base_dir = '/Users/rahulrahul/Documents/Python/Data/Forecasted_Temperature'
    ...
    request_url = request_url = 'https://ukclimateprojections-ui.metoffice.gov.uk/wps?service=wps&request=Execute&version=1.0.0&Identifier=LS1_Subset_02&Format=text/xml&Inform=true&Store=false&Status=false&DataInputs=Area={};'\
                                'Collection=land-prob;DataFormat=csv;ReturnPeriod=rp20;Scenario=rcp85;TemporalAverage=jja;TimeSlice=2020%7C2061;Variable=tasmax'
    Area_value = row['Area']
    ...
    for filename in os.listdir(base_dir):
        if filename.endswith(".csv"):
            ...
            output_csv_path = '/Users/rahulrahul/Documents/Python/Data/Forecasted_Temperature_output.csv'
